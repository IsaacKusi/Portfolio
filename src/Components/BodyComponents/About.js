            ...
            <div className="container py-10">
                <div className="about p-4  mt-20  text-white leading-7 rounded  flex flex-col  md:flex-row md:skew-x-6 md:skew-y-3">
                    <div className='flex place-content-center my-2 md:my-0 md:place-content-start md:w-screen'>
                        <img src={image} alt="sample.png" className='md:animate-wiggle rounded-full w-60 h-45 md:rounded md:w-67 md:h-50 ' />
                    </div>
                    <p className='ml-2 text-md font-sans text-justify'>
                        ...
                        In my sparetime, I love to contribute to open source projects and read technical blogs. </span> <span className='font-bold anim_text'>Driven by a desire to make a positive
