...
const Skills = () => {
    return <>
        <main className="container mt-16 py-8 ">
            <div className='skill flex  items-center place-content-center md:flex md:justify-between md:px-40 py-2 rounded-2xl '>
                ...
                <div className='animate-pulse'>
                    <img src={python} alt="sample.png" width='150px' height='50px' className='skill rounded-2xl' />
                    <img src={djrestFramework} alt="sample.png" width='150px' height='50px' className='skill mt-3 h-20 rounded-2xl' />
                    <img src={Docker} alt="sample.png" width='150px' height='50px' className='skill mt-3 h-20 rounded-2xl' />
                    <img src={websocket} alt="sample.png" width='150px' height='50px' className='skill mt-3 h-20 rounded-2xl' />
                    <img src={postgres} alt="sample.png" width='150px' height='50px' className='skill mt-3 h-20 rounded-2xl' />
                </div>
            </div>
        </main>
    </>
