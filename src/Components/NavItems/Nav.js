        ...
        <main className="bg-transparent fixed top-5 left-0 right-0" >
            <div className="container flex justify-between">
                ...
                <div className=' hidden md:flex md:justify-between md:items-center font-semibold mt-1 text-white '>
                    ...
                    <Link to='/about'> <p className= {`ml-1 px-1  h-8 ${state.aboutActive}`} onClick={aboutFocusHandler} > About </p></Link>
                    <Link to='/skills'><p className={`ml-1 px-1  h-8 ${state.skillActive}`} onClick={skillFocusHandler}> Skills </p></Link>
                    <Link to='/projects'><p className={`ml-1 px-1  h-8 ${state.projectActive}`} onClick={projectFocusHandler}> Projects </p></Link>
                </div>
